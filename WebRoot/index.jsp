			...
			<div class="row-fluid">
				<div class="span4">
					<div>
						...
						<a class="btn blue thickbox" title="添加新角色" href="RolePage/createRole.jsp?TB_iframe=true&height=350&width=500"><i class="icon-plus icon-white"></i> 新增</a>
					</div>
				</div>
				<div class="span8">
...
<!-- END CONTAINER -->
<!-- Begin新增角色隐藏窗口 -->
<!-- <div id="addrole-modal" class="modal hide fade in" style="display:none;">
				<div class="modal-header">
					<button data-dismiss="modal" class="close" type="button"></button>
					<h3>新增角色</h3>
				</div>
